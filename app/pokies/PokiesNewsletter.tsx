...
export default function PokiesNewsletter() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://readdy.ai/api/form/d4to5omu005hmhpl8cf0', {
        method: 'POST',
        headers: {
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Get exclusive pokies insights, early access to new game reviews, and weekly strategy tips 
              delivered straight to your inbox from Australia's trusted gaming experts.
            </p>
          </div>

          {!isSubmitted ? (
            <form 
              id="pokies-newsletter-form"
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-blue-900 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl whitespace-nowrap"
                  >
                ...
                <div className="mt-6 text-center">
                  <p className="text-blue-200 text-sm">
                    Join 25,000+ Australian players who trust <strong className="text-amber-300">IK118</strong> for their pokies gaming insights
                  </p>
                </div>
              </div>
            </form>
            ...
            <div className="max-w-2xl mx-auto bg-green-500/20 backdrop-blur-sm border border-green-400/30 rounded-2xl p-8">
              <div className="text-center">
                ...
                <p className="text-green-200">
                  Thank you for joining! Check your email for our welcome package with exclusive pokies strategies.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-blue-200 text-sm">Weekly reviews of the latest pokies games and features</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-200 text-sm">Proven strategies to maximize your pokies gaming sessions</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-200 text-sm">Early access to new pokies releases and bonus opportunities</p>
            </div>
          </div>
